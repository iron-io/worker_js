(function(root, factory) {
  ...
  /**
   * Jobs service.
   * @module iron_titan/JobsApi
   * @version 0.1.1
   */

  /**
   * Constructs a new JobsApi. 
   * @alias module:iron_titan/JobsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:iron_titan/JobsApi~jobIdCancelPostCallback
     ...
     * @param {module:iron_titan/JobsApi~jobIdCancelPostCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:iron_titan/JobsApi~jobIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JobWrapper} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Gets a job by id.
     * @param {String} id Job id
     * @param {module:iron_titan/JobsApi~jobIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/JobWrapper}
     */
     ...
     * @callback module:iron_titan/JobsApi~jobIdLogGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} id Job id
     * @param {module:iron_titan/JobsApi~jobIdLogGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:iron_titan/JobsApi~jobIdPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JobWrapper} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:iron_titan/JobsApi~jobIdPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/JobWrapper}
     */
     ...
     * @callback module:iron_titan/JobsApi~jobIdRetryPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JobWrapper} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id Job id
     * @param {module:iron_titan/JobsApi~jobIdRetryPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/JobWrapper}
     */
     ...
     * @callback module:iron_titan/JobsApi~jobsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:iron_titan/JobsApi~jobsGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:iron_titan/JobsApi~jobsNameGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JobsWrapper} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} opts.n Number of jobs to return.
     * @param {module:iron_titan/JobsApi~jobsNameGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/JobsWrapper}
     */
     ...
     * @callback module:iron_titan/JobsApi~jobsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JobsWrapper} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:iron_titan/JobsApi~jobsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/JobsWrapper}
     */
