...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkerJs.Complete();
  });
  ...
  describe('Complete', function() {
    it('should create an instance of Complete', function() {
      // uncomment below and update the code to test Complete
      //var instane = new WorkerJs.Complete();
      //expect(instance).to.be.a(WorkerJs.Complete);
    });
